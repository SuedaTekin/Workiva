 ...
 */
final class Version20260330075707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD responsible VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE project ADD progress INT NOT NULL');
